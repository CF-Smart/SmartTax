...
const LoginForm: React.FC<LoginFormProps> = ({ onLogin, empresa, onVoltar }) => {
        ...
        <div className="bg-[#0F2A5F] rounded-3xl p-8 shadow-2xl border border-white/10">
          ...
          {onVoltar && (
            <button
              type="button"
              onClick={onVoltar}
              className="mb-4 px-4 py-2 bg-[#2F6BFF]/20 hover:bg-[#2F6BFF]/30 rounded-lg text-[#E5F0FF] hover:text-white transition-colors"
            >
